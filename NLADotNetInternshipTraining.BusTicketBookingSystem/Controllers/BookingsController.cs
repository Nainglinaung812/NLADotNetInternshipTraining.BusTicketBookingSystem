...
public class BookingsController : ControllerBase
{
    ...
    public IActionResult GetBookings()
    {
        var bookings = _db.Bookings
            ...
            .Select(b => new BookingModel
            {
                ...
                DepartureTime = b.Seats.Where(s => s.BookingId == b.Id).Select(s => s.Schedule.DepartureTime).FirstOrDefault(),
    ...
    public IActionResult GetBooking(Guid id)
    {
        ...
        var result = new BookingModel
        {
            ...
            DepartureTime = Convert.ToDateTime(firstSeat?.Schedule?.DepartureTime), //firstSeat?.Schedule?.DepartureTime,
